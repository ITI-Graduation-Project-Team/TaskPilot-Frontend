        ...
        <div class="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center justify-between bg-surface border border-border p-4 rounded-2xl shadow-sm">
          ...
          <div class="flex bg-background border border-border p-1 rounded-xl overflow-x-auto custom-scrollbar shrink-0">
            <button (click)="activeTab.set('active')" 
                    ...
                    class="px-5 py-2 text-sm font-bold rounded-lg transition-all whitespace-nowrap min-w-[100px]">{{ 'dashboard.hub.activeDraft' | translate }}</button>
            <button (click)="activeTab.set('completed')" 
                    ...
                    class="px-5 py-2 text-sm font-bold rounded-lg transition-all whitespace-nowrap min-w-[100px]">{{ 'dashboard.hub.completed' | translate }}</button>
            <button (click)="activeTab.set('archived')" 
                    ...
                    class="px-5 py-2 text-sm font-bold rounded-lg transition-all whitespace-nowrap min-w-[100px]">{{ 'dashboard.hub.archived' | translate }}</button>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center flex-1 justify-end">
            <div class="relative flex-1 sm:max-w-[280px]">
              <span class="absolute top-1/2 start-3.5 -translate-y-1/2 text-text-secondary pointer-events-none">
              ...
              <input type="text" 
                     ...
                     [placeholder]="'dashboard.hub.searchProjects' | translate" 
                     class="w-full bg-background border border-border rounded-xl ps-10 pe-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium placeholder:text-text-secondary/70" />
            </div>
            ...
            <button (click)="onCreateProject()" 
              ...
              <span>{{ 'dashboard.hub.newProject' | translate }}</span>
            </button>
          </div>
        </div>
      }
