...
@Component({
  ...
  template: `
    <div class="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 animate-fade-in">
      ...
      <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/5 text-left rtl:text-right">
        ...
        <div class="p-8">
          ...
          <div class="group relative flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 transition-all duration-300">
            ...
            <div class="flex items-start gap-5">
              ...
              <div class="text-left rtl:text-right">
                <h4 class="font-bold text-slate-900 dark:text-white text-lg tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
    ...
    this.googleCalendarService.getConnectUrl()
      ...
      .subscribe({
        ...
        error: (err) => {
          ...
          this.toastService.show('Failed to connect to Google Calendar. Please check if the API is running.', 'error');
        }
      });
  }
}
